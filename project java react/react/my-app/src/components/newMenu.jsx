    ...
    <Box sx={{ flexGrow: 1 ,position: 'fixed', top: 0, left:"0", width: '100%', textAlign: 'center', zIndex:9999 ,marginButtom:15}}>
      <AppBar position="static">
        ...
        <div style={{ display: 'flex', justifyContent: 'center' ,height:"30%",top:0}}>
          ...
          <Link to="/newMenu/about" style={{ textDecoration: 'none'}}>
            <h2 style={{ textDecoration: 'none',color:"white",left:0,padding:4,
 fontSize:12}}>|about</h2>
          </Link>
          <Link to="/newMenu/cards" style={{ textDecoration: 'none'}}>
            <h2 style={{ textDecoration: 'none',
 fontSize:17}}>|Requests</h2>
          </Link>
          <Link to="/" style={{ top:0 ,textDecoration: 'none'}}>
            <h2 style={{ top:0}}><img src={logo}  style={{width:78,height:78,top:0}}></img></h2>
          </Link>
          <Link to="/newMenu/signIn" style={{ ftextDecoration: 'none' }}>
            <h2 style={{ fontSize:17,textDecoration: 'none' }}>|signIn/Up</h2>
          </Link>
          <Link to="/newMenu/cards" style={{ textDecoration: 'none'}}>
            <h2 style={{ textDecoration: 'none',
 fontSize:17}}>|Requests</h2>
